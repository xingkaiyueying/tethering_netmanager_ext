...
inline napi_value CreateStringUtf8(napi_env,const std::string &s) {auto v=new Value;v->text=s;return v;}
...
int main() {
 ...
 puts("S4 NAPI converter: capability unknown, modes, dual families, fallback, exact uint64 strings PASS");
}
''', encoding="utf-8")
